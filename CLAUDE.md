...
If the user says yes, apply the `secure-design` skill. If no, proceed without it and note that secure review was declined. Skip the question only for trivial, non-security-relevant changes such as docs, comments, formatting, or behavior-preserving renames.
